...
class ScrapeTable:
    ...
    def convert_to_json(self, json_file_name: str):
        ...
        # Create a JSON file
        with open(json_file_name, "w") as my_file:
            json.dump(results, my_file)
    
    def convert_to_json_bytes(self):
        # Get the results from the scraper
        results = self.run_scraper()
        ...
        # Write the reading of the JSON into the binary format
